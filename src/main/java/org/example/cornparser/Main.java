...
public class Main {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        Future<CronExpression> future1 = concurrentParser.parseCronExpression("* 1-10 * * MON-THU /usr/bin/find");
        Future<CronExpression> future2 = concurrentParser.parseCronExpression("12 * * 1 * 1-5 /usr/bin/backup");
